...
left = pygame.image.load('practice09/Micki/left-hand.png')
right = pygame.image.load('practice09/Micki/right-hand.png')
background = pygame.image.load('practice09/Micki/main-clock.png')       #uploading
